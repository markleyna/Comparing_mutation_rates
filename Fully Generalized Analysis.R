...
#while (n <= nrow(Genes)){
  ...
  TextBox$sendKeysToElement(list(Gene1RunTitle))
  TextBox$sendKeysToElement(list("\uE007")) #line break
  TextBox$sendKeysToElement(list(Gene1Test))
  TextBox$sendKeysToElement(list("\uE007"))
  TextBox$sendKeysToElement(list(Gene2RunTitle))
  TextBox$sendKeysToElement(list("\uE007"))
  TextBox$sendKeysToElement(list(Gene2Test))
  ...
  Gene1RunTitle <- substring(Gene1RunTitle, 2)
  Gene2RunTitle <- substring(Gene2RunTitle,2)
